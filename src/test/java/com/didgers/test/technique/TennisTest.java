...
class TennisTest {
    ...
    private static Stream<Arguments> provideSequenceForDeuce() {
        return Stream.of(
                Arguments.of("Given score are equals and less then 40 then the game is NOT DEUCE","AB", false),
    ...
    private static Stream<Arguments> provideSequenceForWinner() {
        return Stream.of(
                Arguments.of("Given score is playerA:40/playerB: x<40 and playerA won the ball Then playerA is winner","AABBAA", 'A', true),
                ...
                Arguments.of("No winner : Given score is playerA:15/ playerB:15","AB", 'B', false),
                Arguments.of("No Winner:  Given score is playerA:15/ playerB:15","AB", 'A', false)
